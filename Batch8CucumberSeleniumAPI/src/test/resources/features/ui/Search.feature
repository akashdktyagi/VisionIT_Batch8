...
Feature: Search functionality
  ...
  @TC0004
	...
	@TC0010 
	 Scenario:In Search Box If End User Give Combination Of (Symbol Characters And Number) As A Input Its Give An Error As NO Result(Given Input) Try Checking Your Spelling Or Use More General Term.
		Given I have browser opened and url is navigated
